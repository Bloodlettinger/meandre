...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Phase.title_ru'
        db.add_column('phases_phase', 'title_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Phase.title_en'
        db.add_column('phases_phase', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Step.title_ru'
        db.add_column('phases_step', 'title_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Step.title_en'
        db.add_column('phases_step', 'title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Phase.title_ru'
        db.delete_column('phases_phase', 'title_ru')

        # Deleting field 'Phase.title_en'
        db.delete_column('phases_phase', 'title_en')

        # Deleting field 'Step.title_ru'
        db.delete_column('phases_step', 'title_ru')

        # Deleting field 'Step.title_en'
        db.delete_column('phases_step', 'title_en')
