...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('storage_membership', (
            ...
            ('role', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.MembershipRole'])),
        ...
        # Adding M2M table for field staff on 'Membership'
        db.create_table('storage_membership_staff', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('membership', models.ForeignKey(orm['storage.membership'], null=False)),
            ('staff', models.ForeignKey(orm['storage.staff'], null=False))
        ))
        db.create_unique('storage_membership_staff', ['membership_id', 'staff_id'])

    def backwards(self, orm):
        # Deleting model 'Membership'
        db.delete_table('storage_membership')

        # Removing M2M table for field staff on 'Membership'
        db.delete_table('storage_membership_staff')
