...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.object_square2'
        db.add_column('storage_project', 'object_square2',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=2),
                      keep_default=False)

        # Adding field 'Project.price_full2'
        db.add_column('storage_project', 'price_full2',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=2),
                      keep_default=False)

        # Adding field 'Project.exchange_rate2'
        db.add_column('storage_project', 'exchange_rate2',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=19, decimal_places=2),
                      keep_default=False)

        # Adding field 'Project.productivity2'
        db.add_column('storage_project', 'productivity2',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=2),
                      keep_default=False)

        # Adding field 'Project.price_average2'
        db.add_column('storage_project', 'price_average2',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Project.object_square2'
        db.delete_column('storage_project', 'object_square2')

        # Deleting field 'Project.price_full2'
        db.delete_column('storage_project', 'price_full2')

        # Deleting field 'Project.exchange_rate2'
        db.delete_column('storage_project', 'exchange_rate2')

        # Deleting field 'Project.productivity2'
        db.delete_column('storage_project', 'productivity2')

        # Deleting field 'Project.price_average2'
        db.delete_column('storage_project', 'price_average2')
    ...
    models = {
        ...
        'storage.project': {
            ...
            'exchange_rate2': ('django.db.models.fields.DecimalField', [], {'default': '1', 'max_digits': '19', 'decimal_places': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'object_square2': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '19', 'decimal_places': '2'}),
            'price_average': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '19', 'decimal_places': '4'}),
            'price_average2': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '19', 'decimal_places': '2'}),
            'price_full': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '19', 'decimal_places': '4'}),
            'price_full2': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '19', 'decimal_places': '2'}),
            ...
            'productivity2': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '19', 'decimal_places': '2'}),
