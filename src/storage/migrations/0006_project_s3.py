...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_column('storage_project', 'exchange_rate')
        db.delete_column('storage_project', 'object_square')
        db.delete_column('storage_project', 'productivity')
        db.delete_column('storage_project', 'price_full')
        db.delete_column('storage_project', 'price_average')

        db.rename_column('storage_project', 'exchange_rate2', 'exchange_rate')
        db.rename_column('storage_project', 'object_square2', 'object_square')
        db.rename_column('storage_project', 'productivity2', 'productivity')
        db.rename_column('storage_project', 'price_full2', 'price_full')
        db.rename_column('storage_project', 'price_average2', 'price_average')

    def backwards(self, orm):
        db.rename_column('storage_project', 'exchange_rate', 'exchange_rate2')
        db.rename_column('storage_project', 'object_square', 'object_square2')
        db.rename_column('storage_project', 'productivity', 'productivity2')
        db.rename_column('storage_project', 'price_full', 'price_full2')
        db.rename_column('storage_project', 'price_average', 'price_average2')

        db.add_column('storage_project', 'exchange_rate',
                      self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=19, decimal_places=4),
                      keep_default=False)
        db.add_column('storage_project', 'object_square',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=4),
                      keep_default=False)
        db.add_column('storage_project', 'productivity',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=4),
                      keep_default=False)
        db.add_column('storage_project', 'price_full',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=4),
                      keep_default=False)
        db.add_column('storage_project', 'price_average',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=4),
                      keep_default=False)
    ...
    models = {
        ...
        'storage.project': {
            ...
            'object_square': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '19', 'decimal_places': '2'}),
