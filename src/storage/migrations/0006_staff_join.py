...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Staff.first_name'
        db.add_column('storage_staff', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Staff.last_name'
        db.add_column('storage_staff', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Staff.company'
        db.add_column('storage_staff', 'company',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Staff.site'
        db.add_column('storage_staff', 'site',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Staff.first_name'
        db.delete_column('storage_staff', 'first_name')

        # Deleting field 'Staff.last_name'
        db.delete_column('storage_staff', 'last_name')

        # Deleting field 'Staff.company'
        db.delete_column('storage_staff', 'company')

        # Deleting field 'Staff.site'
        db.delete_column('storage_staff', 'site')
