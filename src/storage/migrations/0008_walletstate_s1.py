...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'WalletState.amount'
        db.alter_column('storage_walletstate', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=2))

    def backwards(self, orm):
        # Changing field 'WalletState.amount'
        db.alter_column('storage_walletstate', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=4))
    models = {
        'auth.group': {
