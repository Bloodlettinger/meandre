...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FinanceTransaction.exchange_rate'
        db.alter_column('storage_financetransaction', 'exchange_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=2))

        # Changing field 'FinanceTransaction.amount'
        db.alter_column('storage_financetransaction', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'FinanceTransaction.exchange_rate'
        db.alter_column('storage_financetransaction', 'exchange_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=19, decimal_places=4))

        # Changing field 'FinanceTransaction.amount'
        db.alter_column('storage_financetransaction', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=19, decimal_places=4))
