...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Staff.address_ru'
        db.add_column('storage_staff', 'address_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Staff.address_en'
        db.add_column('storage_staff', 'address_en',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Staff.first_name_ru'
        db.add_column('storage_staff', 'first_name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Staff.first_name_en'
        db.add_column('storage_staff', 'first_name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Staff.last_name_ru'
        db.add_column('storage_staff', 'last_name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Staff.last_name_en'
        db.add_column('storage_staff', 'last_name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Staff.company_ru'
        db.add_column('storage_staff', 'company_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Staff.company_en'
        db.add_column('storage_staff', 'company_en',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Staff.address_ru'
        db.delete_column('storage_staff', 'address_ru')

        # Deleting field 'Staff.address_en'
        db.delete_column('storage_staff', 'address_en')

        # Deleting field 'Staff.first_name_ru'
        db.delete_column('storage_staff', 'first_name_ru')

        # Deleting field 'Staff.first_name_en'
        db.delete_column('storage_staff', 'first_name_en')

        # Deleting field 'Staff.last_name_ru'
        db.delete_column('storage_staff', 'last_name_ru')

        # Deleting field 'Staff.last_name_en'
        db.delete_column('storage_staff', 'last_name_en')

        # Deleting field 'Staff.company_ru'
        db.delete_column('storage_staff', 'company_ru')

        # Deleting field 'Staff.company_en'
        db.delete_column('storage_staff', 'company_en')
