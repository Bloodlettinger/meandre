...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('storage_project', 'long_name', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'Project.long_name_en'
        db.alter_column('storage_project', 'long_name_en', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

        # Changing field 'Project.long_name_ru'
        db.alter_column('storage_project', 'long_name_ru', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

    def backwards(self, orm):
        # Changing field 'Project.long_name'
        db.alter_column('storage_project', 'long_name', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Project.long_name_en'
        db.alter_column('storage_project', 'long_name_en', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Project.long_name_ru'
        db.alter_column('storage_project', 'long_name_ru', self.gf('django.db.models.fields.TextField')(null=True))
    models = {
        'auth.group': {
