...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Customer.short_name_ru'
        db.add_column('storage_customer', 'short_name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Customer.short_name_en'
        db.add_column('storage_customer', 'short_name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Customer.long_name_ru'
        db.add_column('storage_customer', 'long_name_ru',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Customer.long_name_en'
        db.add_column('storage_customer', 'long_name_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Customer.short_name_ru'
        db.delete_column('storage_customer', 'short_name_ru')

        # Deleting field 'Customer.short_name_en'
        db.delete_column('storage_customer', 'short_name_en')

        # Deleting field 'Customer.long_name_ru'
        db.delete_column('storage_customer', 'long_name_ru')

        # Deleting field 'Customer.long_name_en'
        db.delete_column('storage_customer', 'long_name_en')
