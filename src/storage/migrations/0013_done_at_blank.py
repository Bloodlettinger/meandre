...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'FinanceTransaction.done_at'
        db.alter_column('storage_financetransaction', 'done_at', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Changing field 'FinanceTransaction.done_at'
        db.alter_column('storage_financetransaction', 'done_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
