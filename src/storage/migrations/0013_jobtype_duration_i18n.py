...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobType.duration_ru'
        db.add_column('storage_jobtype', 'duration_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobType.duration_en'
        db.add_column('storage_jobtype', 'duration_en',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'JobType.duration_ru'
        db.delete_column('storage_jobtype', 'duration_ru')

        # Deleting field 'JobType.duration_en'
        db.delete_column('storage_jobtype', 'duration_en')
