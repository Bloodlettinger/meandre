...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('storage_project', 'is_public', 'is_public_ru')
        db.add_column('storage_project', 'is_public_en',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        db.rename_column('storage_project', 'is_public_ru', 'is_public')
        db.delete_column('storage_project', 'is_public_en')
