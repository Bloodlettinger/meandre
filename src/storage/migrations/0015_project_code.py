...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('storage_project', 'code',
                      self.gf('django.db.models.fields.CharField')(max_length=9, unique=True, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Project.code'
        db.delete_column('storage_project', 'code')
    ...
    models = {
        ...
        'storage.project': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'max_length': '9', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
