...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recommendation.name_ru'
        db.add_column('storage_recommendation', 'name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Recommendation.name_en'
        db.add_column('storage_recommendation', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Recommendation.name_ru'
        db.delete_column('storage_recommendation', 'name_ru')

        # Deleting field 'Recommendation.name_en'
        db.delete_column('storage_recommendation', 'name_en')
