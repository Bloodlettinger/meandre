...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('storage_project', 'code', self.gf('django.db.models.fields.CharField')(default='null', unique=True, max_length=9))

    def backwards(self, orm):
        # Changing field 'Project.code'
        db.alter_column('storage_project', 'code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=9, null=True))
