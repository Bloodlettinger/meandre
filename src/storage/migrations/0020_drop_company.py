...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Membership.company'
        db.delete_column('storage_membership', 'company_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Membership.company'
        db.add_column('storage_membership', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['storage.CompanyTeam'], null=True, blank=True),
                      keep_default=False)
