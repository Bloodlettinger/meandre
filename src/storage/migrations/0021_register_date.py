...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.reg_date'
        db.add_column('storage_project', 'reg_date',
                      self.gf('django.db.models.fields.DateField')(default=timezone.now),
                      keep_default=False)

        # Changing field 'Project.registered'
        db.alter_column('storage_project', 'registered', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'Project.reg_date'
        db.delete_column('storage_project', 'reg_date')

        # Changing field 'Project.registered'
        db.alter_column('storage_project', 'registered', self.gf('django.db.models.fields.DateTimeField')())
