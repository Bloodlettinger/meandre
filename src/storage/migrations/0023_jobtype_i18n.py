...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'JobType.short_title_ru'
        db.add_column('storage_jobtype', 'short_title_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobType.short_title_en'
        db.add_column('storage_jobtype', 'short_title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobType.long_title_ru'
        db.add_column('storage_jobtype', 'long_title_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobType.long_title_en'
        db.add_column('storage_jobtype', 'long_title_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobType.description_ru'
        db.add_column('storage_jobtype', 'description_ru',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'JobType.description_en'
        db.add_column('storage_jobtype', 'description_en',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'JobType.short_title_ru'
        db.delete_column('storage_jobtype', 'short_title_ru')

        # Deleting field 'JobType.short_title_en'
        db.delete_column('storage_jobtype', 'short_title_en')

        # Deleting field 'JobType.long_title_ru'
        db.delete_column('storage_jobtype', 'long_title_ru')

        # Deleting field 'JobType.long_title_en'
        db.delete_column('storage_jobtype', 'long_title_en')

        # Deleting field 'JobType.description_ru'
        db.delete_column('storage_jobtype', 'description_ru')

        # Deleting field 'JobType.description_en'
        db.delete_column('storage_jobtype', 'description_en')
