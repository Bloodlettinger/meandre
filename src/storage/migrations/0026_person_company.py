...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StaffPerson.company'
        db.add_column('storage_staffperson', 'company',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'StaffPerson.company'
        db.delete_column('storage_staffperson', 'company')
