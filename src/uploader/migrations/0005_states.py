...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Queue.visible'
        db.add_column('uploader_queue', 'visible',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Queue.staff'
        db.add_column('uploader_queue', 'staff',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Queue.teaser'
        db.add_column('uploader_queue', 'teaser',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Queue.visible'
        db.delete_column('uploader_queue', 'visible')

        # Deleting field 'Queue.staff'
        db.delete_column('uploader_queue', 'staff')

        # Deleting field 'Queue.teaser'
        db.delete_column('uploader_queue', 'teaser')
