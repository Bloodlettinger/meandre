...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomUser.company'
        db.add_column('users_customuser', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.Company'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CustomUser.company'
        db.delete_column('users_customuser', 'company_id')
