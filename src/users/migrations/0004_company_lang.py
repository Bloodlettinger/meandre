...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Company.name_ru'
        db.add_column('users_company', 'name_ru',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Company.name_en'
        db.add_column('users_company', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Company.name_ru'
        db.delete_column('users_company', 'name_ru')

        # Deleting field 'Company.name_en'
        db.delete_column('users_company', 'name_en')
